    ...
    <section class="section-card strip-card">
      ...
      <div class="rail product-rail">
        ${products.length ? products.map((product) => `
          <article class="rail-product-card" data-action="open-product" data-product-id="${escapeHtml(product.product_id)}">
...
function productCardHtml(product) {
  ...
  return `
    <article class="product-card" data-action="open-product" data-product-id="${escapeHtml(product.product_id)}">
...
function dealCardHtml(item, type, activeFlash = null) {
  ...
  return `
    <article class="deal-card" data-action="toggle-${type}" data-id="${escapeHtml(item.id)}">
