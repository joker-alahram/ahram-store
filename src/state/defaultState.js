...
export function createInitialState() {
  ...
  return {
    ...
    auth: {
      ...
      selectedCustomer: normalizeSessionRecord(loadJSON(storageKeys.selectedCustomer, null)),
      loginBusy: false,
      registerBusy: false,
    },
    commerce: {
      ...
      catalog: cachedCatalog && typeof cachedCatalog === 'object' ? { ...createEmptyCatalog(), ...cachedCatalog, products: [], productIndex: {} } : createEmptyCatalog(),
      invoices: [],
      invoiceItemsById: {},
      customers: [],
      top: { products: [], companies: [] },
