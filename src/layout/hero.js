    ...
    <section class="hero-shell hero-shell--flash">
      ...
      <div class="hero-shell__details hero-shell__details--compact">
        <div class="hero-shell__thumb hero-shell__thumb--secondary">
          ${heroImage ? `<img src="${dom.escape(heroImage)}" alt="${dom.escape(offer.title)}" loading="eager" decoding="async" />` : `<div class="hero-shell__thumb-fallback">${dom.escape(fallback)}</div>`}
        </div>
