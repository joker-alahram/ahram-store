...
export function renderLoginModal(state) {
  return `
    <section class="modal-overlay modal-overlay--center ${state.ui.activeModal === 'login' ? 'is-open' : 'is-hidden'}" data-modal="login">
...
export function renderCustomerModal(state) {
  return `
    <section class="modal-overlay modal-overlay--center ${state.ui.activeModal === 'customer' ? 'is-open' : 'is-hidden'}" data-modal="customer">
...
export function renderProductModal(state, product) {
  ...
  return `
    <section class="modal-overlay modal-overlay--center ${state.ui.activeModal === 'product' ? 'is-open' : 'is-hidden'}" data-modal="product">
...
export function renderInvoiceModal(state) {
  ...
  return `
    <section class="modal-overlay modal-overlay--center is-open" data-modal="invoice">
