...
const state = {
  ...
  dataReady: Boolean(cachedDataset && ((cachedDataset.products?.length || cachedDataset.companies?.length || cachedDataset.dailyDeals?.length || cachedDataset.flashOffers?.length))),
  behavior: {
    visitedDeals: false,
    visitedFlash: false,
