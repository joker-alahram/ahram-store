const CONFIG = {
  ...
  supportPhone: localStorage.getItem('support_phone') || '01040880002',
  supportFacebook: localStorage.getItem('support_facebook') || 'https://www.facebook.com/alahram2014/',
  orderWhatsapp: '201040880002',
};
...
function contactActionsHtml() {
  ...
  const whatsappDigits = String(CONFIG.orderWhatsapp || CONFIG.supportWhatsapp || '').replace(/\D+/g, '');
  const facebookUrl = String(CONFIG.supportFacebook || 'https://www.facebook.com/alahram2014/').trim();
...
function openExternalLink(url) {
  if (!url || url === '#') {
    toast(SYSTEM_MESSAGES.contact.unavailable);
    return;
  }
...
const SYSTEM_MESSAGES = {
  login: {
    missing: 'يرجى إدخال اسم المستخدم أو رقم الهاتف وكلمة المرور.',
    invalid: 'بيانات تسجيل الدخول غير صحيحة، يرجى التحقق والمحاولة مرة أخرى.',
    password: 'كلمة المرور غير صحيحة، يرجى التحقق والمحاولة مرة أخرى.',
    success: 'تم تسجيل الدخول بنجاح.',
  },
  register: {
    invalid: 'يرجى استكمال جميع الحقول المطلوبة قبل المتابعة.',
    duplicate: 'رقم الهاتف مسجل مسبقًا، يرجى استخدام رقم آخر أو تسجيل الدخول.',
    success: 'تم إنشاء الحساب بنجاح. يمكنك الآن متابعة الطلب.',
  },
  customer: {
    selected: 'تم اختيار العميل بنجاح.',
    saved: 'تم حفظ العميل بنجاح.',
    needRep: 'هذه الصفحة مخصصة للمندوب فقط.',
  },
  cart: {
  ...
  tier: {
    ...
    cleared: 'تم إلغاء الشريحة المحددة.',
  },
  checkout: {
    validate: 'تم التحقق من الطلب بنجاح. يرجى الضغط على إرسال الطلب لإكمال العملية.',
    missing: 'يرجى استكمال جميع الحقول المطلوبة قبل المتابعة.',
    blocked: 'لا يمكن إتمام الطلب، توجد بيانات غير مكتملة.',
    submitted: 'تم إرسال الطلب بنجاح.',
  },
  contact: {
    unavailable: 'الرابط غير متاح حاليًا.',
  },
  errors: {
    generic: 'حدث خطأ غير متوقع، يرجى المحاولة مرة أخرى.',
    network: 'تعذر الاتصال بالخادم، يرجى التحقق من الاتصال والمحاولة مرة أخرى.',
    location: 'تعذر تحديد الموقع، يرجى المحاولة مرة أخرى.',
    login: 'تعذر تسجيل الدخول الآن.',
    register: 'تعذر إنشاء الحساب الآن.',
    customer: 'تعذر حفظ العميل الآن.',
    checkout: 'تعذر إتمام الطلب الآن.',
    invoices: 'تعذر تحميل البيانات الآن.',
  },
};

const TOAST_NORMALIZATION = new Map([
  ['سجّل الدخول أولًا', SYSTEM_MESSAGES.login.missing],
  ['يرجى تسجيل الدخول أولاً.', SYSTEM_MESSAGES.login.missing],
  ['يجب تسجيل الدخول أو إنشاء حساب لإتمام الطلب.', SYSTEM_MESSAGES.login.missing],
  ['اكتب رقم الهاتف أو اسم المستخدم وكلمة المرور.', SYSTEM_MESSAGES.login.missing],
  ['بيانات الدخول غير صحيحة أو الحساب غير موجود.', SYSTEM_MESSAGES.login.invalid],
  ['كلمة المرور غير صحيحة، راجعها ثم حاول مرة أخرى.', SYSTEM_MESSAGES.login.password],
  ['تم تسجيل الدخول بنجاح.', SYSTEM_MESSAGES.login.success],
  ['تم تسجيل الخروج', 'تم تسجيل الخروج بنجاح.'],

  ['تم التسجيل بنجاح، يمكنك الآن استكمال التسوق أو إرسال طلبك.', SYSTEM_MESSAGES.register.success],
  ['تعذر إنشاء الحساب الآن', SYSTEM_MESSAGES.errors.register],
  ['تعذر إضافة العميل', SYSTEM_MESSAGES.errors.customer],
  ['تم إضافة العميل', SYSTEM_MESSAGES.customer.saved],
  ['تم حفظ السلة', SYSTEM_MESSAGES.cart.saved],
  ['السلة فارغة الآن', SYSTEM_MESSAGES.cart.empty],
  ['السلة فارغة.', SYSTEM_MESSAGES.cart.empty],
  ['السلة فارغة', SYSTEM_MESSAGES.cart.empty],
  ['تمت الإضافة للسلة', SYSTEM_MESSAGES.cart.add],
  ['تمت الإزالة من السلة', SYSTEM_MESSAGES.cart.remove],
  ['يجب اختيار شريحة قبل إتمام الطلب.', SYSTEM_MESSAGES.tier.missing],
  ['يرجى اختيار الشريحة المناسبة لعرض الأسعار بشكل صحيح.', SYSTEM_MESSAGES.tier.missing],
  ['الطلب محتاج استيفاء قبل الإرسال.', SYSTEM_MESSAGES.checkout.blocked],
  ['الموقع غير مدعوم على الجهاز', 'تعذر استخدام الموقع على هذا الجهاز.'],
  ['تم تحديد الموقع', 'تم تحديد الموقع بنجاح.'],
  ['تعذر تحديد الموقع', SYSTEM_MESSAGES.errors.location],
  ['تعذر تحميل البيانات من قاعدة البيانات', SYSTEM_MESSAGES.errors.network],
  ['تعذر تسجيل الدخول الآن.', SYSTEM_MESSAGES.errors.login],
  ['تعذر إتمام الطلب الآن.', SYSTEM_MESSAGES.errors.checkout],
  ['تم التحقق من الطلب بنجاح، اضغط إرسال الطلب لإكمال العملية.', SYSTEM_MESSAGES.checkout.validate],
  ['تم إرسال الطلب بنجاح.', SYSTEM_MESSAGES.checkout.submitted],
  ['تعذر الاتصال بالخادم، يرجى التحقق من الاتصال والمحاولة مرة أخرى.', SYSTEM_MESSAGES.errors.network],
]);

function normalizeSystemMessage(message) {
  const raw = String(message ?? '').trim();
  if (!raw) return '';
  return TOAST_NORMALIZATION.get(raw) || raw;
}

function toast(message) {
  els.toast.textContent = normalizeSystemMessage(message);
  els.toast.classList.remove('hidden');
  clearTimeout(toastTimer);
...
function smartToast(typeOrMessage, fallback, force = false) {
  ...
  const direct = section && kind && SYSTEM_MESSAGES[section] ? SYSTEM_MESSAGES[section][kind] : null;
  const message = direct || normalizeSystemMessage(fallback ?? typeOrMessage);
...
function canShowMessage() { return true; }
function randomDelay() { return 30000; }
...
function validateRegister(data) {
  ...
  if (!data.password || data.password.length < 4) {
    return 'يرجى إدخال كلمة مرور مكونة من 4 أرقام على الأقل.';
  }
...
async function registerCustomer() {
  ...
  try {
    ...
    toast(SYSTEM_MESSAGES.register.success);
    state.pendingReturnHash = null;
    state.pendingOpenCart = false;
    navigate('#home');
  } catch (error) {
    console.error(error);
    toast(SYSTEM_MESSAGES.errors.register);
  }
}
...
function openMyData() {
  if (!state.session) {
    toast(SYSTEM_MESSAGES.login.missing);
    return;
  }
  renderMyDataContent();
...
function openMyCustomers() {
  ...
  if (state.session.userType !== 'rep') {
    toast(SYSTEM_MESSAGES.customer.needRep);
    return;
  }
...
function selectCustomer(id) {
  ...
  closeAddCustomer();
  toast(SYSTEM_MESSAGES.customer.selected);
  navigate('#home');
}
...
async function saveCustomer() {
  ...
  try {
    ...
    toast(SYSTEM_MESSAGES.customer.saved);
    closeAddCustomer();
    ...
    console.error(error);
    toast(SYSTEM_MESSAGES.errors.customer);
  }
}
...
function updateFlashHeader() {
  ...
  if (flashState.offer && flashState.status === 'active') {
...
async function loadData() {
  try {
    ...
    console.error(error);
    toast(SYSTEM_MESSAGES.errors.network);
    renderApp();
  }
}
...
function renderFlashPage() {
  ...
  els.pageContent.innerHTML = `
    <div class="page-stack">
      <section class="flash-hero flash-hero-center">
        <div class="flash-copy flash-copy-center">عرض الساعة</div>
      </section>
      <section class="deal-list">
...
function dealCardHtml(item, type, activeFlash = null) {
  ...
  const status = type === 'flash'
    ? (item.status === 'active' ? 'متاح الآن' : 'غير متاح')
  ...
  if (registerLocateBtn) {
    registerLocateBtn.addEventListener('click', () => {
      ...
      if (!navigator.geolocation) {
        toast('تعذر استخدام الموقع على هذا الجهاز.');
        return;
      }
      navigator.geolocation.getCurrentPosition(
        ...
        () => {
          toast(SYSTEM_MESSAGES.errors.location);
        },
...
async function handleSelectTier(tier) {
  ...
  if (current === tier.tier_name) {
    ...
    renderApp();
    navigate('#home');
    toast(SYSTEM_MESSAGES.tier.cleared);
    return;
  }
  ...
  renderApp();
  navigate('#home');
  toast(SYSTEM_MESSAGES.tier.selected);
}
...
function toggleDeal(type, id) {
  ...
  if (!item) return;
  if (type === 'deal' && !item.can_buy) return toast('العرض غير متاح حاليًا.');
  if (type === 'flash' && !item.can_buy) return toast('العرض غير متاح حاليًا.');
  const key = `${type}:${item.id}:single`;
  const existing = findCartItem(key);
  if (existing) {
...
function validateBeforeOrder() {
  ...
  if (!state.cart.length) {
    toast(SYSTEM_MESSAGES.cart.empty);
    return false;
  }
  ...
  if (!tier || !tier.tier_name) {
    closeCart();
    navigate('#tiers');
    toast(SYSTEM_MESSAGES.tier.missing);
    return false;
  }
  ...
  if (state.session.userType === 'rep' && !state.selectedCustomer) {
    closeCart();
    navigate('#my-customers');
    toast(SYSTEM_MESSAGES.checkout.missing);
    return false;
  }

  const missingData = !String(state.session.name || '').trim() || !String(state.session.phone || '').trim() || !String(state.session.address || state.session.location || '').trim();
  if (missingData) {
    closeCart();
    navigate('#register');
    toast(SYSTEM_MESSAGES.checkout.missing);
  ...
  if (Number(total) < Number(tier.min_order || 0)) {
    closeCart();
    navigate('#tiers');
    toast(SYSTEM_MESSAGES.tier.incomplete);
    return false;
  }
...
function buildWhatsAppInvoice(order, items) {
  const invoiceId = order?.id || order?.order_number || `ORD-${Date.now()}`;
  const isRep = state.session.userType === 'rep';
  const rep = isRep ? state.session : null;
  const customer = isRep ? state.selectedCustomer : state.session;

  const repBlock = isRep
    ? `👨‍💼 بيانات المندوب
الاسم: ${rep?.name || ''}
الهاتف: ${rep?.phone || ''}
المنطقة: ${rep?.region || rep?.area || rep?.zone || rep?.address || ''}
━━━━━━━━━━━━━━
`
    : '';

  const customerBlock = `👤 بيانات العميل
الاسم: ${customer?.name || ''}
الهاتف: ${customer?.phone || ''}
العنوان: ${customer?.address || customer?.location || ''}
`;

  let message = `🧾 فاتورة طلب شراء رقم الفاتورة: ${invoiceId}

━━━━━━━━━━━━━━
👤 نوع العميل: ${isRep ? 'مندوب' : 'عميل مباشر'}
${repBlock}━━━━━━━━━━━━━━
${customerBlock}
━━━━━━━━━━━━━━
📦 الشريحة ${getSelectedTierLabel()}
━━━━━━━━━━━━━━
📋 تفاصيل الطلب
`;
...
كود الصنف: ${item.id}
الوحدة: ${unitLabel}
سعر الوحدة: ${num(item.price)} جنيه
الكمية: ${item.qty}
الإجمالي: ${num(Number(item.qty || 0) * Number(item.price || 0))} جنيه
━━━━━━━━━━━━━━
`;
  });

  message += `
💰 إجمالي الفاتورة: ${num(order.total_amount)} جنيه
━━━━━━━━━━━━━━
`;
...
function sendToWhatsApp(order, items) {
  const phone = String(CONFIG.orderWhatsapp || CONFIG.supportWhatsapp || '').replace(/\D+/g, '');
...
async function handleCheckout() {
  ...
  try {
    if (state.checkoutStage === 'validate') {
      toast(SYSTEM_MESSAGES.checkout.validate);
    ...
    if (state.checkoutStage === 'submit') {
      ...
      toast(SYSTEM_MESSAGES.checkout.submitted);
    ...
    resetCheckoutStage();
    syncCheckoutButton();
    toast(SYSTEM_MESSAGES.errors.checkout);
  }
}
...
async function handleLogin() {
  ...
  try {
    ...
    if (!user) {
      toast(SYSTEM_MESSAGES.login.invalid);
      return;
    }
    if (String(user.password || '').trim() !== password) {
      toast(SYSTEM_MESSAGES.login.password);
      return;
    }
    ...
    updateHeader();
    renderApp();
    toast(SYSTEM_MESSAGES.login.success);
  } catch (error) {
    console.error(error);
    toast(SYSTEM_MESSAGES.errors.login);
  }
}
...
function wireGlobalEvents() {
  ...
  els.saveCartBtn.addEventListener('click', () => {
    persistCart();
    toast(SYSTEM_MESSAGES.cart.saved);
  });
}
