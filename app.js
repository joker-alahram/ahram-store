...
function purchaseSummaryCapsuleHtml() {
  return `
    <div class="search-summary-chip" aria-label="قيمة المشتريات">
      <span class="search-summary-icon" aria-hidden="true">
        <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true">
          <path fill="currentColor" d="M6 4h15l-1.5 8H8L6 4zm2 10a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm9 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zM4 2a1 1 0 0 0-1 1v1h2l2.1 10.4A2 2 0 0 0 9.1 16H19a1 1 0 1 0 0-2H9.1l-.2-1h11.3a1 1 0 0 0 1-.8l1.8-9A1 1 0 0 0 22 2H4z"/>
        </svg>
      </span>
      <span class="search-summary-value mono">${integer(cartTotal())}</span>
      <span class="search-summary-currency">ج.م</span>
    </div>
  `;
}
      ...
      <div class="invoice-topline">
        <div class="invoice-main">
          ...
          <div class="invoice-meta-row">
            <span class="invoice-date">${escapeHtml(formatDateTime(order.created_at))}</span>
            <span class="invoice-customer">${escapeHtml(order.customer_name || 'غير محدد')}</span>
            <span class="invoice-status">${escapeHtml(getStatusLabel(order.status))}</span>
          </div>
        </div>
        <div class="invoice-amount mono">${num(order.total_amount)} ج.م</div>
      </div>
...
function setupMobileFooterNavigation() {
  ...
  if (!footer) {
    footer = document.createElement('nav');
    footer.id = 'mobileFooterNav';
    footer.className = 'mobile-footer-nav footer-compact-mode';
    footer.setAttribute('aria-label', 'التنقل السفلي');
    document.body.appendChild(footer);
  }
  els.mobileFooterNav = footer;
