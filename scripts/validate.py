...
def main() -> int:
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            github_pages_ok = ('/src/main.tsx' not in index_html) and ('/src/main.js' not in index_html) and ('/assets/' in index_html)
        ...
        results.append(step('Deployment-agnostic build success', github_pages_ok))
